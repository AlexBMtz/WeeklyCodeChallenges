...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine($"¿Existe el código 55? {exists55}"); // Debería ser True
        Console.WriteLine($"¿Existe el código 7? {exists7}"); // Debería ser False
        Console.WriteLine("--------------------------------------------------\n");
        ...
        PrintDictionary(noChangeDict); // Debe seguir igual
        Console.WriteLine("--------------------------------------------------\n");
